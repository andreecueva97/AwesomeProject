...
const Juego_Mapa = ({ navigation, route }) => {
  ...
  const fontSizeX = (15 * Dimensions.get('window').height) / 759.2727;
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.inicio_View}>
        <View style={{ flex: 1, zIndex: 10, backgroundColor: 'grey', }}>
          ...
          <View style={[styles.buttonLocalidad, { top: -40*((Dimensions.get('window').height) / 759.2727) , left: 660 *((Dimensions.get('window').width) / 392.7272),}]}>
              ...
              renderItem={({ item }) =>
                <View style={{ fontSize: fontSizeX, backgroundColor: '#DFDFE2', justifyContent: 'space-between', alignItems: "center", flexDirection: 'row', justifyContent: "center" }}>
                  ...
                  <View style={{ backgroundColor: 'white' }} >
                    <Text style={{ textAlign: 'center', justifyContent: "center", alignItems: "center", width: (40*Dimensions.get('window').width)/392.7272, fontSize: (12*Dimensions.get('window').height*Dimensions.get('window').width)/(759.2727*392.7272), color: '#371B1F', top: (4 * Dimensions.get('window').height) / 759.2727, backgroundColor: '#DFDFE2' }}>
                      {/* {(juegoPosiciones.findIndex((element) => element === item))} */}
                      {posiciones.findIndex(element => element === item)}
                    </Text>
                  </View>
                  <View style={{ backgroundColor: 'white' }} >
                    <Text style={{ textAlign: 'center', justifyContent: "center", alignItems: "center", width: (70*Dimensions.get('window').width)/392.7272, fontSize: (12*Dimensions.get('window').height*Dimensions.get('window').width)/(759.2727*392.7272), color: '#371B1F', top: (4 * Dimensions.get('window').height) / 759.2727, backgroundColor: '#DFDFE2' }}>
                      {item}
                    </Text>
                  </View>
                  <View style={{ backgroundColor: 'white' }} >
          ...
          >
            <View style={{ zIndex: 10, left: 10, top: 300*((Dimensions.get('window').height) / 759.2727), transform: [{ rotate: '90 deg' }], backgroundColor: 'white' }}>
              <View style={{ backgroundColor: "#AABECF", padding: 20, borderRadius: 3 }}>
                ...
                >
                  <Text style={{ color: 'white', fontSize: 12*((Dimensions.get('window').height) / 759.2727) }}>continuar</Text>
                </TouchableHighlight>
              </View>
            </View>
          </Modal>
