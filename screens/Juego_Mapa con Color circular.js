    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.inicio_View}>
        <View style={{ flex: 1, zIndex: 10, backgroundColor: 'grey', }}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-5%', left: '186.3%', }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-12%', left: '115%', }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-10%', left: '95%', }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-12%', left: '143.5%', }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-13%', left: '184%', }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-8%', left: '184%' }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-18%', left: '157%' }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-8%', left: '167%' }]}>
          ...
          <View style={[styles.buttonLocalidad, { top: '-16%', left: '125%' }]}>
